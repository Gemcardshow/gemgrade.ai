...
/**
 * Live Gem Card Show Pro Scan variants. Each purchased scan grants two
 * GemGrade credits; Shopify line-item quantity is applied separately.
 */
export const SHOPIFY_PRO_SCAN_VARIANT_CREDITS = Object.freeze({
  "56437258551462": 20, // 10 Pro Scans
  "56437261041830": 50, // 25 Pro Scans
  "56591607955622": 100, // 50 Pro Scans
  "56594782093478": 200, // 100 Pro Scans
});
...
export function loadShopifyCreditMaps() {
  return {
    variantMap: {
      ...parseCreditMapEnv(process.env.SHOPIFY_CREDIT_VARIANT_MAP),
