...
test("fetchUserScanHistory uses lightweight select and filters by user_id", async () => {
  const row = {
    id: "scan-1",
    created_at: "2026-06-10T12:00:00.000Z",
    mode: "scout",
...
test("fetchUserScanById uses lightweight select and filters by user_id", async () => {
  const row = {
    id: "scan-2",
